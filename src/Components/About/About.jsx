...
const About = () => {
    return (
        <div data-aos="fade-up" className="my-6">
            <div className="font-semibold text-4xl text-[#3c6e71] p-3">
            <Typewriter
            words={['About Us']}
            loop={100}
            cursor
          ...
          />
            ...
            <div className="space-y-5 p-3">
                <p className="text-2xl font-medium my-2">Welcome to Momentum Daily, your go-to source for breaking news, insightful analysis, and thought-provoking articles. At Momentum Daily, we believe in the power of information to inspire and drive positive change. Our dedicated team of journalists, writers, and editors is committed to delivering accurate, timely, and engaging content that keeps you informed and connected to the world around you.</p>
                <p><h1 className="text-center font-semibold text-3xl text-[#284b63] my-1"><u>Our Mission</u></h1>
                ...
                <p><h1 className="text-center font-semibold text-3xl text-[#284b63] my-1"><u>Premium Content</u></h1>
                <p className="text-2xl font-medium my-2">
                ...
                <p><h1 className="text-center font-semibold text-3xl text-[#284b63] my-1"><u>Non-Premium Articles</u></h1>
                <p className="text-2xl font-medium my-2">
